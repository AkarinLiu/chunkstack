<x-admin-layouts.admin>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">编辑标签</h1>

        <form method="POST" action="{{ route('admin.tags.update', $tag) }}" class="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PUT')
