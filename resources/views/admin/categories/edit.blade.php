            ...
            <div class="mb-6">
                <label class="flex items-center cursor-pointer">
                    ...
                    <input
                        ...
                        class="sr-only"
                    >
                    <div id="toggle_slot" class="toggle-slot relative w-11 h-6 {{ old('is_active', $category->is_active) ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600' }} rounded-full cursor-pointer transition-colors">
                        <div id="toggle_handle" class="toggle-handle absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow transition-transform duration-200 ease-in-out {{ old('is_active', $category->is_active) ? 'translate-x-5' : '' }}"></div>
                    </div>
